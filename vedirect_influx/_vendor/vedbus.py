# Vendored from victronenergy/velib_python -> vedbus.py (MIT License).
# Source: https://github.com/victronenergy/velib_python
# Provides VeDbusService for registering com.victronenergy.* services on D-Bus.
# Unmodified except this header. Excluded from lint/type/doctest (see pyproject).
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
